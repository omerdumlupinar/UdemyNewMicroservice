...
namespace UdemyNewMicroservice.Catalog.Api.Repositories
{
    public class CourseEntityConfiguration : IEntityTypeConfiguration<Course>
    {
        public void Configure(EntityTypeBuilder<Course> builder)
        {
            ...
            builder.Property(x => x.CreatedDate).HasElementName("createdate");
            builder.Property(x => x.CategoruId).HasElementName("categoryid");
            ...
            builder.OwnsOne(c => c.Feature, feature =>
            {
                ...
                feature.Property(x => x.EducationFullName).HasElementName("educationfullname");
            });
        }
    }
}
